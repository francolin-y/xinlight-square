...
const marketCopies = {
  cn: {
    ...
    requestIntro: "女主人公提交后会先进入站长审核；站长创建的礼物会直接上架。",
    requestName: "礼物标题",
    ...
    requestIcon: "图标",
    requestImage: "礼物图片",
    requestImageHelp: "站长上传图片后，礼物卡片会显示真实图片。",
    requestType: "类型",
    requestSubmitHeroine: "提交给站长审核",
    requestSubmitAdmin: "直接上架礼物",
    requestSuccessHeroine: "礼物需求已提交给站长审核。",
    requestSuccessAdmin: "礼物已直接上架。",
    requestOnly: "只有女主人公和站长可以上传礼物需求。",
    requestMissing: "请填写礼物标题和有效定价。",
    requestFailed: "提交失败",
    adminTodoTitle: "站长待处理礼物需求",
    ...
    pendingStatus: "等待站长审核",
    redeemSuccess: "兑换成功，等待站长填写到货时间。",
    redeemFailed: "兑换失败",
    redeemOnlyHeroine: "目前只有女主人公可以兑换礼物。",
